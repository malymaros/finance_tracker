...
extension AppLocalizationsMonths on AppLocalizations {
  ...
  String categoryName(ExpenseCategory cat) => switch (cat) {
        ...
        ExpenseCategory.electronics => categoryElectronics,
        ...
        ExpenseCategory.household => categoryHousehold,
        ExpenseCategory.personalCare => categoryPersonalCare,
        ExpenseCategory.savings => categorySavings,
        ExpenseCategory.debt => categoryDebt,
        ExpenseCategory.kids => categoryKids,
        ExpenseCategory.pets => categoryPets,
        ExpenseCategory.fees => categoryFees,
        ExpenseCategory.fuel => categoryFuel,
        ExpenseCategory.maintenance => categoryMaintenance,
        ExpenseCategory.donations => categoryDonations,
