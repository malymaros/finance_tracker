...
/// Shows the individual expense items that belong to a single [category]
/// for the given [period].
class CategoryExpenseListScreen extends StatefulWidget {
  ...
  @override
  State<CategoryExpenseListScreen> createState() =>
      _CategoryExpenseListScreenState();
}
        ...
        children: [
          CircleAvatar(
            ...
            child: Icon(widget.category.icon,
                size: 20, color: widget.category.color),
          ),
